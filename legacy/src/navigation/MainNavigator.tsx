...
import { PlaygroundDetailScreen } from '@/screens/main/PlaygroundDetailScreen';
...
function FeedNavigator() {
  return (
    <FeedStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <FeedStack.Screen name="PlaygroundDetail" component={PlaygroundDetailScreen} />
      <FeedStack.Screen name="FriendProfile" component={FriendProfileScreen} />
      <FeedStack.Screen name="CheckInDetail" component={CheckInDetailScreen} />
    </FeedStack.Navigator>
  );
}
